...
def check(resources, output, scope, enabled, release=None, mode="stop"):
    ...
    runtime = release / 'runtime' if release else resources / 'cua_node'
    cli = release / 'host/bin/codex' if release else resources / 'codex'
    host = release / 'host' if release else resources / 'plugins/openai-bundled'
